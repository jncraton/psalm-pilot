...
def check_hymn_example_text(page: Page, hymn: dict):
    expect(page.get_by_text('Example Text').locator("+ dd")).to_contain_text(f"{hymn['firstLine'] or ''}...{hymn['refrainFirstLine'] or ''}")
